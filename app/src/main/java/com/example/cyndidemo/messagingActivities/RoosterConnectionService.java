...
public class RoosterConnectionService extends Service {
    ...
    public static final String UI_AUTHENTICATED = "com.example.cyndidemo.messagingActivities.uiauthenticated";
    public static final String SEND_MESSAGE = "com.example.cyndidemo.messagingActivities.sendmessage";
    public static final String BUNDLE_MESSAGE_BODY = "b_body";
    public static final String BUNDLE_TO = "b_to";

    public static final String NEW_MESSAGE = "com.example.cyndidemo.messagingActivities.newmessage";
    ...
    private Handler mTHandler;//We use this handler to post messages to the background thread.
